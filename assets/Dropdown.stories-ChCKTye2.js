const c={title:"Components/Dropdown",parameters:{layout:"fullscreen"}},a="/styles/layout.css",p="/styles/dropdown.css";function l(){document.querySelectorAll("[data-dd]").forEach(d=>{d.querySelector(".dd-trigger").addEventListener("click",()=>d.classList.toggle("dd-open")),d.querySelectorAll(".dd-option").forEach(s=>{s.addEventListener("click",()=>{d.classList.remove("dd-open");const o=d.querySelector(".dd-label");o.textContent=s.textContent.trim()})}),document.addEventListener("click",s=>{d.contains(s.target)||d.classList.remove("dd-open")})})}const n=()=>(setTimeout(l,0),`
  ...
  `);n.parameters={docs:{source:{code:'<div class="dd dd-m"><span class="dd-label">Label</span></div>',state:"closed"}},stencil:{usage:"Dropdown en estado abierto con lista de opciones desplegable.",html:'<spain-dropdown size="m" label="Label" open="true"><spain-dropdown-option>Option 1</spain-dropdown-option><spain-dropdown-option>Option 2</spain-dropdown-option></spain-dropdown>',css:`
.dd {
  position: relative;
...
`}};var i,e,t;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  setTimeout(script, 0);
  return \`
  ...
  \`;
}`,...(t=(e=n.parameters)==null?void 0:e.docs)==null?void 0:t.source}}};const v=["Default"];export{n as Default,v as __namedExportsOrder,c as default};
