...
`;t.parameters={docs:{source:{code:'<div class="alert-card alert-success"><div class="alert-title">Title</div><div class="alert-desc">Description</div></div>',state:"closed"}},stencil:{usage:"Ejemplo de cómo usar el Alert como Web Component de Stencil con diferentes variantes.",html:'<spain-alert variant="success" title="Congratulations!" description="You successfully subscribed to our newsletter." show-close="true"></spain-alert>',css:`
.alert-card {
  display: flex;
  gap: 12px;
...
\``,...(n=(s=t.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};const r=["Default"];export{t as Default,r as __namedExportsOrder,l as default};
