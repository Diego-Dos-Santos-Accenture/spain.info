const c={title:"Components/Dropdown",parameters:{layout:"fullscreen"}},a="/styles/layout.css",p="/styles/dropdown.css";function l(){document.querySelectorAll("[data-dd]").forEach(n=>{n.querySelector(".dd-trigger").addEventListener("click",()=>n.classList.toggle("dd-open")),n.querySelectorAll(".dd-option").forEach(s=>{s.addEventListener("click",()=>{n.classList.remove("dd-open");const t=n.querySelector(".dd-label");t.textContent=s.textContent.trim()})}),document.addEventListener("click",s=>{n.contains(s.target)||n.classList.remove("dd-open")})})}const d=()=>(setTimeout(l,0),`
  ...
  `);d.parameters={docs:{source:{code:'<div class="dd dd-m"><span class="dd-label">Label</span></div>',state:"closed"}},stencil:{usage:"Dropdown en estado abierto con lista de opciones desplegable.",html:'<spain-dropdown size="m" label="Label" open="true"><spain-dropdown-option>Option 1</spain-dropdown-option><spain-dropdown-option>Option 2</spain-dropdown-option></spain-dropdown>',css:`.dd{position:relative;display:inline-block;width:100%;max-width:200px}
...
`}};var i,e,o;d.parameters={...d.parameters,docs:{...(i=d.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  setTimeout(script, 0);
  return \`
  ...
  \`;
}`,...(o=(e=d.parameters)==null?void 0:e.docs)==null?void 0:o.source}}};const v=["Default"];export{d as Default,v as __namedExportsOrder,c as default};
