...
`;t.parameters={docs:{source:{code:'<div class="tabs"><button class="tab-btn is-active">Tab</button></div>',state:"closed"}},stencil:{usage:"Ejemplo funcional con dos tabs: una interactiva (Active/ Hover/ Selected) y otra Disabled.",html:"<spain-tabs-demo></spain-tabs-demo>",css:`.tabs__list{display:flex;gap:8px;padding:6px 0;border-radius:999px;width:fit-content;background:#fff}
...
.tabs__btn:not(:disabled):not(.tabs__btn--active):not(.tabs__btn--selected):hover{background:transparent;border-color:#FFD300;color:#1B1C20}`,tsx:`import { Component, h, State } from "@stencil/core";
