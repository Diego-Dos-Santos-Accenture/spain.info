      ...
      <div class="tb-container">
        ...
        <div class="tb-card">
          <spain-table
            ...
            rows='${JSON.stringify([["Turistas internacionales recibidos",">85,6 millones","+14,3 %","+1,9 %","Primer año que supera los registros previos a la pandemia"],["Gasto turístico",">108.692 millones de euros","+23,9 %","+18,2 %","Fuerte recuperación cualitativa, sobre todo en calidad del turismo (gasto medio)"],["Mercado emisor Estados Unidos","3,8 millones de turistas","+39,7 %","+16,9 %","EE.UU. como mercado destacado por crecimiento en gasto y pernoctaciones"],["Llegadas hasta noviembre 2024 / récord acumulado parcial",">83,6 millones de turistas internacionales hasta noviembre 2024","+10,7 %","+13,7 %"," "]])}'
          ></spain-table>
        </div>
        ...
        <div class="tb-card tb-full">
          <spain-table
            ...
            rows='${JSON.stringify([["Title","Obligatorio","Mín de 60 caracteres","Título de la tabla"],["Category row","Obligatorio","Máx de 30 caracteres por item","Títulos de columna"],["Body text","Obligatorio","Máx de 120 caracteres por item","Descripción/valor"],["Botón","Opcional","–","Acción"]])}'
          ></spain-table>
        </div>
      </div>
    </div>
  </div>
`;e.parameters={docs:{source:{code:'<spain-table headers="[]" rows="[]"></spain-table>',state:"closed"}},stencil:{usage:"Tabla adaptable en Stencil. Copia HTML, CSS y TSX para reutilizarla sin cambios visuales.",html:'<spain-table headers="["Col 1","Col 2"]" rows="[["A","B"],["C","D"]]"></spain-table>',css:`.tb, .table__table{width:100%;border-collapse:collapse;font-size:14px;color:#1D1C20}
.tb thead th{background:#1B1C20;color:#fff;text-align:left;padding:12px;font-weight:600;font-size:12px}
.tb tbody td{padding:12px;border-top:1px solid #EAEAEA;font-size:12px;color:#4A4A4A}`,tsx:`import { Component, h, Prop } from "@stencil/core";
...
export class SpainTable {
...
}`}};const o=(()=>{const a=document.createElement("script");return a.innerHTML=`
    (function(){
  ...
  `,a.outerHTML})();var t,s,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`() => \`
      ...
      <div class="tb-container">
        ...
        <div class="tb-card">
          <spain-table
            variant="master"
            headers='["Category title","Category title","Category title","Category title","Category title"]'
            rows='\${JSON.stringify(Array.from({
  length: 5
}).map(() => ["Body text", "Body text", "Body text", "Body text", "Body text"]))}'
          ></spain-table>
        </div>
...
\``,...(r=(s=e.parameters)==null?void 0:s.docs)==null?void 0:r.source}}};const d=["Default"];export{e as Default,d as __namedExportsOrder,l as default};
