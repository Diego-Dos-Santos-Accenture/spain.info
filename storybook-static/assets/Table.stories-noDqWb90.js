...
`;e.parameters={docs:{source:{code:'<spain-table headers="[]" rows="[]"></spain-table>',state:"closed"}},stencil:{usage:"Tabla adaptable en Stencil. Copia HTML, CSS y TSX para reutilizarla sin cambios visuales.",html:'<spain-table headers="["Col 1","Col 2"]" rows="[["A","B"],["C","D"]]"></spain-table>',css:`
.tb, .table__table {
  width: 100%;
