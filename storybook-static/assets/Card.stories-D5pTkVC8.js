...
`;a.parameters={docs:{source:{code:'<div class="card"><img class="card__image" /><div class="card__content"><h3 class="card__title">Title</h3></div></div>',state:"closed"}},stencil:{usage:"Use the Card as a Stencil component in HTML or JSX.",html:'<spain-card title="El norte por explorar" description="Montañas, costas bravas y un clima refrescante." image="/images/imgCard1.png" orientation="vertical"></spain-card>',css:`.card{display:flex;flex-direction:column;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);transition:all 0.2s;cursor:pointer}
...
`}};var r,i,e;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:`() => \`
...
\``,...(e=(i=a.parameters)==null?void 0:i.docs)==null?void 0:e.source}}};const d=["Default"];export{a as Default,d as __namedExportsOrder,n as default};
