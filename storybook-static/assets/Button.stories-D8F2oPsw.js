...
`;n.parameters={docs:{source:{code:'<button class="btn btn-primary btn-l">Button</button>',state:"closed"}},stencil:{usage:"Botón primario con diferentes tamaños y estados.",html:'<spain-button variant="primary" size="l">Button</spain-button>',css:`.btn{display:inline-flex;align-items:center;gap:8px;padding:12px 24px;border-radius:24px;border:none;font-weight:600;cursor:pointer;transition:all 0.2s}
...
`;e.parameters={docs:{source:{code:'<button class="btn btn-secondary btn-l">Button</button>',state:"closed"}},stencil:{usage:"Botón secundario con borde y fondo transparente.",html:'<spain-button variant="secondary" size="l">Button</spain-button>',css:`.btn{display:inline-flex;align-items:center;gap:8px;padding:12px 24px;border-radius:24px;border:none;font-weight:600;cursor:pointer;transition:all 0.2s}
...
`;s.parameters={docs:{source:{code:'<button class="btn btn-tertiary btn-l">Button</button>',state:"closed"}},stencil:{usage:"Botón terciario con estilo minimalista.",html:'<spain-button variant="tertiary" size="l">Button</spain-button>',css:`.btn{display:inline-flex;align-items:center;gap:8px;padding:12px 24px;border-radius:24px;border:none;font-weight:600;cursor:pointer;transition:all 0.2s}
...
`;o.parameters={docs:{source:{code:'<button class="btn btn-link btn-l">Button</button>',state:"closed"}},stencil:{usage:"Botón con estilo de enlace para acciones secundarias.",html:'<spain-button variant="link" size="l">Button</spain-button>',css:`.btn{display:inline-flex;align-items:center;gap:8px;padding:12px 24px;border-radius:24px;border:none;font-weight:600;cursor:pointer;transition:all 0.2s}
...
`;i.parameters={docs:{source:{code:'<div class="dark-theme"><button class="btn btn-primary">Button</button></div>',state:"closed"}},stencil:{usage:"Todos los botones en tema oscuro con estilos adaptados.",html:'<div class="dark-theme"><spain-button variant="primary" size="l">Button</spain-button></div>',css:`.dark-theme{background:#1B1C20;color:#fff;padding:24px;border-radius:8px}
