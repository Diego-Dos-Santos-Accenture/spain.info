...
Default.parameters = { 
  docs: { source: { code: '<spain-pagination size="m" current-page="2" total-pages="10" show-numbers="false"></spain-pagination>', state: 'closed' } },
  stencil: {
    usage: 'Paginación con dos variantes: sin numeración (solo botones) y con numeración (botones + indicador de página).',
    html: '<!-- Sin numeración -->\n<spain-pagination size="m" show-numbers="false" current-page="2" total-pages="10"></spain-pagination>\n\n<!-- Con numeración -->\n<spain-pagination size="m" show-numbers="true" current-page="2" total-pages="10"></spain-pagination>\n\n<!-- Tema oscuro -->\n<spain-pagination size="m" show-numbers="false" current-page="2" total-pages="10" dark-theme="true"></spain-pagination>',
    css: `/* Pagination Component Styles */
.pagination {
  display: flex;
  align-items: center;
  gap: 8px;
